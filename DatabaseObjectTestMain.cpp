...
int main(){
	...
	cout<<"This test program gives a thorough demonstration of database functionalities\n";
	...
	***************/
	...
	c2.push_back(Condition("Owner", EQUALS, Entry("Davin"), NONE, 1));
	...
	localRelations.push_back(new Relation(d.deleteFromRelation("Dogs", c3)));
	localRelations.at(8)->setName("Deletion");

	cout<<*localRelations.at(8)<<'\n';

	cout<<"NOTICE: These operations effect the relations themseleves\n\n";

	cout<<*d.accessRelation("Dogs")<<'\n';

	localRelations.push_back(new Relation(d.insertIntoFromRelation("Dogs", localRelations.at(0))));
	localRelations.at(9)->setName("InsertFromPrevious");

	cout<<*localRelations.at(9)<<'\n';
