...
SportsLeague::SportsLeague( ) {
	...
	// Check if the relation files exist. If they do just open them.
	// Otherwise create the relation and the file.
...
// function that runs on exit that writes and closes relation files
